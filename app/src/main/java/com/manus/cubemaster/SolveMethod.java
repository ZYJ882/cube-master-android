...
public enum SolveMethod {
    ...
    EDGES_FIRST(
            ...
            "经典策略",
            "独立路线先规划至全部 12 条棱已复原、角处于已验证纯角中间态的目标；随后仅使用保持棱不变的纯角宏完成全部 8 个角。",
            new String[]{"1. 完整十二棱：目标态验证", "2. 纯角收尾：保持十二棱并完成八角"}),
    CORNERS_FIRST(
            "真实角先",
            "Corners First · Pure-Edge Finish",
            "经典策略",
            "独立路线先规划至全部 8 个角已复原、棱处于已验证纯棱中间态的目标；随后仅使用保持角不变的纯棱宏完成全部 12 条棱。",
            new String[]{"1. 完整八角：目标态验证", "2. 纯棱收尾：保持八角并完成十二棱"}),
    ZZ(
            "真实 ZZ",
