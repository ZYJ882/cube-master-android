...
import java.util.Arrays;
    ...
    public final class F2L
    {
        ...
        private static void F2L_GO(FridrichSolver Cube)
        {
            Cube.Solution += " ";
        ...
        static void F2L_RG(FridrichSolver Cube)
        {
        ...
        static void F2L_BR(FridrichSolver Cube)
        {
        ...
        static void F2L_OB(FridrichSolver Cube)
        {
            Cube.Solution += " ";
