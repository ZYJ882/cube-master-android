...
public final class RouxSolver {
    ...
    public static Result solve(String currentFacelets) {
        ...
        StageSearch.Goal firstBlock = StageSearch.goal(
        ...
        StageSearch.Goal secondBlock = StageSearch.goal(
                StageSearch.block(new int[]{6, 9, 10}, new int[]{5, 6}, StageSearch.ALL_OUTER_MOVES),
        ...
        StageSearch.Goal cmll = StageSearch.goal(
        ...
        StageSearch.Goal lse = StageSearch.goal(
